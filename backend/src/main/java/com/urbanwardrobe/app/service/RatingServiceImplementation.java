...
import com.urbanwardrobe.app.repository.RatingRepository;
...
public class RatingServiceImplementation implements RatingService{
    ...
    @Override
    public Rating createRating(RatingRequest req, User user) throws ProductException, ProductException {
